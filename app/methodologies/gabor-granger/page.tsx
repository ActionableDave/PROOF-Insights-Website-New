...
export default function GaborGrangerPage() {
  console.log("Gabor Granger page rendered");
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-24" style={{
        backgroundImage: `url('https://assets.macaly-user-data.dev/cdn-cgi/image/format=webp,width=2000,height=2000,fit=scale-down,quality=90,anim=true/jjdzbffced8ekhvw3oom8wsy/qzjda03k524b6cd1a4tyz4pf/c7DlTrojmWLLDzG3Xk8Xy/gabor-granger.png')`,
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8">
            ...
            <h1 className="text-4xl lg:text-6xl font-bold text-proof-gray-900 leading-tight">
              Gabor Granger<span className="text-transparent bg-clip-text bg-gradient-to-r from-proof-blue-600 to-proof-emerald-600 block leading-[1.2]">
                Price Wheel</span></h1>
            <p className="text-xl text-black max-w-3xl mx-auto leading-relaxed">
              Systematically test price points across a range to identify optimal pricing strategies that balance customer acceptance with revenue goals.</p>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <h2 className="text-3xl lg:text-4xl font-bold text-proof-gray-900">
                  Gabor Granger Price Wheel</h2>
              </div>
              <p className="text-lg text-proof-gray-600">
                Gabor Granger (also called Price Laddering or Sequential Price Sensitivity Analysis) is a systematic methodology that tests multiple price points sequentially to understand demand elasticity, identify optimal pricing zones, and determine revenue maximization opportunities across different customer segments and market conditions.</p>
      ...
      <section className="py-20 bg-proof-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6 mb-16">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold text-proof-gray-900">
              Gabor Granger Use Cases</h2>
            <p className="text-lg text-proof-gray-600 max-w-3xl mx-auto">
              Gabor Granger provides systematic insights for revenue optimization, competitive positioning, and strategic pricing decisions across diverse business scenarios.</p>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-6 mb-16">
            <Badge className="bg-proof-blue-100 text-proof-blue-700 border-proof-blue-200 px-4 py-2">
              ...
              Our Gabor Granger Process
            </Badge>
            <h2 className="text-3xl lg:text-4xl font-bold text-proof-gray-900">
              Systematic Price Testing Methodology
            </h2>
            <p className="text-lg text-proof-gray-600 max-w-3xl mx-auto">
              Our rigorous approach to Gabor Granger price testing ensures comprehensive price sensitivity 
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="relative group hover:shadow-lg transition-all duration-300 border-proof-gray-200 hover:border-proof-blue-300">
              ...
              <CardContent className="space-y-4">
                <p className="text-proof-gray-600">
                  Define optimal price ranges and test intervals based on market research, 
      ...
      <section className="py-20 bg-gradient-to-br from-proof-blue-600 to-proof-emerald-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <p className="text-xl text-blue-100 max-w-2xl mx-auto">
            Partner with PROOF Insights to leverage Gabor Granger price sensitivity testing for systematic price optimization, revenue maximization, and strategic competitive positioning.</p>
