            ...
            <div className="relative z-10 bg-white rounded-2xl shadow-2xl p-8 border border-proof-gray-200">
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold text-proof-gray-900">Halo Effect and Cost of Entry</h3>
                  <Badge className="bg-proof-blue-100 text-proof-blue-700">Bias Removal</Badge>
                </div>
                
                <div className="w-full">
                  <img 
                    src="https://assets.macaly-user-data.dev/cdn-cgi/image/format=webp,width=2000,height=2000,fit=scale-down,quality=90,anim=true/jjdzbffced8ekhvw3oom8wsy/qzjda03k524b6cd1a4tyz4pf/z7FmRmxsnmDQ4Xzhsr_tp/expectancy-analysis-page-2.jpg"
                    alt="Halo Effect and Cost of Entry diagram showing how Expectancy Analysis removes these biases"
